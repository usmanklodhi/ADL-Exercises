...
def run(args):
    ...
    # TODO: adjust folder
    dataset = datasets.CIFAR10('/adjust/your/cifar10/folder', download=True, train=True, transform=transform_train)
    ...
    # TODO: adjust folder
    testset = datasets.CIFAR10('/adjust/your/cifar10/folder/', download=True, train=False, transform=transform_test)
